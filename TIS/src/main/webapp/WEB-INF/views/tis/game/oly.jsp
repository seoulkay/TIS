...
<body>
<div style="height: 30em; background-image: url('https://www.ufo79.com/image/201707260446280257.jpg'); background-size:cover">
	<!--     navbar -->
    <jsp:include page="../common/navbar.jsp" flush="false">
		<jsp:param name="param" value="value1" />
	</jsp:include>
	<div style="height: 3em"></div>
	<span style="margin: 0 auto; text-align: center;"><h1 class="title">Olympic Winter Games PyeongChang2018</h1></span>
	...
	<div id="feature-block-1" class="feature-block feature-block-1">
		<div class="row title-row-style">
			<div class="feature-content col-md-6 col-sm-6 col-xs-12">
				<h4 class="feature-title"><span style="background-color: #ed45a4" class="label label-success">PyeongChang 2018 Olympic Winter Games</span></h4>
...
<section id="anchor2">
	<div id="feature-block-2" class="feature-block feature-block-1">
		<div class="row title-row-style">
			<div class="feature-figure col-md-6 col-sm-6 col-xs-12">
				<img class="img-responsive" src="https://www.ufo79.com/image/201708030718500455.JPG">
			</div>
			<div class="feature-content col-md-6 col-sm-6 col-xs-12">
		...
		<div class="row title-row-style" style="background-color:#A9D7E6;">
			<div class="feature-figure col-md-6 col-sm-6 col-xs-12">
				<div class="figure-holder" align="center" style="box-shadow: -10px 10px 10px 1px #666666;">
					<img class="img-responsive" src="https://www.ufo79.com/image/201708030718500482.jpg">
				</div>
			</div>
			<div class="feature-content col-md-6 col-sm-6 col-xs-12">				
